...
`timescale 1ns / 1ps
<<<<<<< HEAD:code_26_2/fpga/FPGA_HDMIIN_Red/project/source/dl_fpga_prj.v
//===============================================================================
// 模块声明：顶层FPGA工程模块
//===============================================================================
=======
...
>>>>>>> 142256c861bf7492833c91a9aacc6afd94f45d52:code_26_2/fpga/template_projects/DL_HDMI40IN_PCIE_RK3568/project/source/dl_fpga_prj.v
module dl_fpga_prj #(
...
wire [127:0]    dma_write_data_from_selector;

localparam DMA_DEBUG_BYPASS_ENABLE = 1'b1;
localparam [15:0] DMA_DEBUG_RGB565 = 16'hF800;

assign dma_write_data = (DMA_DEBUG_BYPASS_ENABLE == 1'b1) ? {8{DMA_DEBUG_RGB565}} : dma_write_data_from_selector;
...
<<<<<<< HEAD:code_26_2/fpga/FPGA_HDMIIN_Red/project/source/dl_fpga_prj.v
    ...
    .dma_wr_data                 (dma_write_data_from_selector            )      // 输出：DMA写数据（128bit）
=======
    .clk                         (pclk_div2),
    .rst_n                       (core_rst_n),
