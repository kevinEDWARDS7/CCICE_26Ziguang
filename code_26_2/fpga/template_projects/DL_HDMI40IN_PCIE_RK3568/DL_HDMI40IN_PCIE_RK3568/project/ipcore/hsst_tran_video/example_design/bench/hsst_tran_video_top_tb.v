...
///////////////////////////////////////////////////////////////////////////////
`timescale 1ns/100fs
module hsst_tran_video_top_tb (
 );

hsst_tran_video_top U_INST_TB (
);
...
begin
    ...
    force hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_pll.pll0_lock_deb.signal_deb
        = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_pll.pll0_lock_deb.signal_b;
    force hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_pll.pll0_lock_deb.signal_deb
        = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_pll.pll0_lock_deb.signal_b;
    
    force hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_tx.SYNC_TXLANE[2].pll_lock_deb.signal_deb
        = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_tx.SYNC_TXLANE[2].pll_lock_deb.signal_b;
    force hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_tx.SYNC_TXLANE[2].pll_lock_deb.signal_deb
        = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_tx.SYNC_TXLANE[2].pll_lock_deb.signal_b;
    
    force hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].i_pll_lock_deb.signal_deb 
        = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].i_pll_lock_deb.signal_b;
    force hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].cdr_align_deb.signal_deb 
        = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].cdr_align_deb.signal_b;
    force hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].i_pll_lock_deb.signal_deb 
        = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].i_pll_lock_deb.signal_b;
    force hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].cdr_align_deb.signal_deb 
        = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.U_IPM2L_HSSTLP_RST.AUTO_MODE.hsstlp_rst_rx.SYNC_RXLANE[2].cdr_align_deb.signal_b;
...
assign p_pll_lock_0            = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PLL_READY_0           ;       
assign p_pll_lock_1            = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PLL_READY_1           ;         
assign p_rx_sigdet_sta[0]      = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_RX_SIGDET_STATUS_0    ;         
assign p_rx_sigdet_sta[1]      = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_RX_SIGDET_STATUS_1    ;         
assign p_rx_sigdet_sta[2]      = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_RX_SIGDET_STATUS_2    ;         
assign p_rx_sigdet_sta[3]      = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_RX_SIGDET_STATUS_3    ;         
assign p_lx_cdr_align[0]       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_LX_CDR_ALIGN_0        ;         
assign p_lx_cdr_align[1]       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_LX_CDR_ALIGN_1        ;         
assign p_lx_cdr_align[2]       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_LX_CDR_ALIGN_2        ;         
assign p_lx_cdr_align[3]       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_LX_CDR_ALIGN_3        ;         
assign p_pcs_lsm_synced[0]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_LSM_SYNCED_0      ;
assign p_pcs_lsm_synced[1]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_LSM_SYNCED_1      ;
assign p_pcs_lsm_synced[2]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_LSM_SYNCED_2      ;
assign p_pcs_lsm_synced[3]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_LSM_SYNCED_3      ;
assign p_pcs_rx_mcb_status[0]  = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_RX_MCB_STATUS_0   ;
assign p_pcs_rx_mcb_status[1]  = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_RX_MCB_STATUS_1   ;
assign p_pcs_rx_mcb_status[2]  = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_RX_MCB_STATUS_2   ;
assign p_pcs_rx_mcb_status[3]  = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.P_PCS_RX_MCB_STATUS_3   ;
assign i_rdisper[4*1-1:4*0]    = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdisper_0         ;
assign i_rdecer[4*1-1:4*0]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdecer_0          ;
assign i_rdisper[4*2-1:4*1]    = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdisper_1         ;
assign i_rdecer[4*2-1:4*1]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdecer_1          ;
assign i_rdisper[4*3-1:4*2]    = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdisper_2         ;
assign i_rdecer[4*3-1:4*2]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdecer_2          ;
assign i_rdisper[4*4-1:4*3]    = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdisper_3         ;
assign i_rdecer[4*4-1:4*3]     = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.i_rdecer_3          ;
assign o_slip_finish           = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.slip_finish         ;
assign o_pl_err                = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST_CHK.o_pl_err            ;
assign o_p_clk2core_tx_0       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_TCLK2FABRIC_0   ;
assign o_p_clk2core_tx_1       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_TCLK2FABRIC_1   ;
assign o_p_clk2core_tx_2       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_TCLK2FABRIC_2   ;
assign o_p_clk2core_tx_3       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_TCLK2FABRIC_3   ;
assign o_p_clk2core_rx_0       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_RCLK2FABRIC_0   ;
assign o_p_clk2core_rx_1       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_RCLK2FABRIC_1   ;
assign o_p_clk2core_rx_2       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_RCLK2FABRIC_2   ;
assign o_p_clk2core_rx_3       = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_GTP_HSSTLP_WRAPPER.P_RCLK2FABRIC_3   ;
assign o_txlane_done_0         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_txlane_done_0     ;
assign o_txlane_done_1         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_txlane_done_1     ;
assign o_txlane_done_2         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_txlane_done_2     ;
assign o_txlane_done_3         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_txlane_done_3     ;
assign o_rxlane_done_0         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_rxlane_done_0     ;
assign o_rxlane_done_1         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_rxlane_done_1     ;
assign o_rxlane_done_2         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_rxlane_done_2     ;
assign o_rxlane_done_3         = hsst_tran_video_top_tb.U_INST_TB.U_DUT_TOP.U_INST.U_IPM2L_HSSTLP_RST.o_rxlane_done_3     ;
...
assign p_pll_lock_if_0            = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PLL_READY_0           ;         
assign p_pll_lock_if_1            = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PLL_READY_1           ;         
assign p_rx_sigdet_sta_if[0]      = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_RX_SIGDET_STATUS_0    ;         
assign p_rx_sigdet_sta_if[1]      = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_RX_SIGDET_STATUS_1    ;         
assign p_rx_sigdet_sta_if[2]      = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_RX_SIGDET_STATUS_2    ;         
assign p_rx_sigdet_sta_if[3]      = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_RX_SIGDET_STATUS_3    ;         
assign p_lx_cdr_align_if[0]       = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_LX_CDR_ALIGN_0        ;         
assign p_lx_cdr_align_if[1]       = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_LX_CDR_ALIGN_1        ;         
assign p_lx_cdr_align_if[2]       = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_LX_CDR_ALIGN_2        ;         
assign p_lx_cdr_align_if[3]       = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_LX_CDR_ALIGN_3        ;         
assign p_pcs_lsm_synced_if[0]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_LSM_SYNCED_0      ;
assign p_pcs_lsm_synced_if[1]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_LSM_SYNCED_1      ;
assign p_pcs_lsm_synced_if[2]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_LSM_SYNCED_2      ;
assign p_pcs_lsm_synced_if[3]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_LSM_SYNCED_3      ;
assign p_pcs_rx_mcb_status_if[0]  = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_RX_MCB_STATUS_0   ;
assign p_pcs_rx_mcb_status_if[1]  = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_RX_MCB_STATUS_1   ;
assign p_pcs_rx_mcb_status_if[2]  = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_RX_MCB_STATUS_2   ;
assign p_pcs_rx_mcb_status_if[3]  = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF.P_PCS_RX_MCB_STATUS_3   ;
assign i_rdisper_if[4*1-1:4*0]    = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdisper_0         ;
assign i_rdecer_if[4*1-1:4*0]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdecer_0          ;
assign i_rdisper_if[4*2-1:4*1]    = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdisper_1         ;
assign i_rdecer_if[4*2-1:4*1]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdecer_1          ;
assign i_rdisper_if[4*3-1:4*2]    = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdisper_2         ;
assign i_rdecer_if[4*3-1:4*2]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdecer_2          ;
assign i_rdisper_if[4*4-1:4*3]    = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdisper_3         ;
assign i_rdecer_if[4*4-1:4*3]     = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.i_rdecer_3          ;
assign o_slip_finish_if           = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.slip_finish         ;
assign o_pl_err_if                = hsst_tran_video_top_tb.U_INST_TB.U_IF_TOP.U_INST_IF_CHK.o_pl_err            ;

generate
if(O_RXLANE_DONE_0=="TRUE") begin
    assign o_rxlane_done[0]    = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_0   ;
    assign o_rxlane_done_if[0] = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_0_if;
end
else begin
...
if(O_RXLANE_DONE_1=="TRUE") begin 
    assign o_rxlane_done[1]    = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_1   ;
    assign o_rxlane_done_if[1] = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_1_if;
end
else begin
...
if(O_RXLANE_DONE_2=="TRUE") begin
    assign o_rxlane_done[2]    = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_2   ;
    assign o_rxlane_done_if[2] = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_2_if;
end
else begin
...
if(O_RXLANE_DONE_3=="TRUE") begin
    assign o_rxlane_done[3]    = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_3   ;
    assign o_rxlane_done_if[3] = hsst_tran_video_top_tb.U_INST_TB.o_rxlane_done_3_if;
end
else begin
