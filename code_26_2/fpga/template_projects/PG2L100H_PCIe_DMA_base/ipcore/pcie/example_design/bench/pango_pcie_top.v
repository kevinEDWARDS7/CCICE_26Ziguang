...
//PCIe wrapper AXIS master output, kept separate from the HDMI-to-DMA path.
wire            pcie_axis_master_tvalid;
wire            pcie_axis_master_tready;
wire    [127:0] pcie_axis_master_tdata;
wire    [3:0]   pcie_axis_master_tkeep;
wire            pcie_axis_master_tlast;
wire    [7:0]   pcie_axis_master_tuser;
...
//----------------------------------------------------------HDMI to DMA AXIS master bridge ----------------------------------------------------------
hdmi_axis_master_bridge #(
    .FRAME_WIDTH            (1280                   ),
    .FRAME_HEIGHT           (720                    )
)
u_hdmi_axis_master_bridge(
    ...
    .axis_tvalid            (axis_master_tvalid     ),
    .axis_tready            (axis_master_tready     ),
...
generate
    ...
    //CFG TLP TX RX     BASE ADDR = 0x9000
        pcie_cfg_ctrl   u_pcie_cfg_ctrl(
            ...
            .axis_master_tvalid     (pcie_axis_master_tvalid),
            .axis_master_tlast      (pcie_axis_master_tlast ),
        //    .axis_master_tuser      (pcie_axis_master_tuser ),
            .axis_master_tkeep      (pcie_axis_master_tkeep ),
            .axis_master_tdata      (pcie_axis_master_tdata )
        );
        ...
        assign axis_master_tready      = pcie_cfg_ctrl_en ? 1'b0                    : axis_master_tready_mem;
        assign pcie_axis_master_tready = pcie_cfg_ctrl_en ? axis_master_tready_cfg  : 1'b1;
    end
    else
    begin:ep
...
//        assign axis_master_tdata_mem   = (axis_master_tlast&axis_master_tvalid&(axis_master_tkeep==4'h1))?128'h0000_0000_0000_0000_0000_0000_AAAA_AAAA:axis_master_tdata;
       assign axis_master_tdata_mem =axis_master_tdata;
        ...
        assign pcie_axis_master_tready = 1'b1;
    end
endgenerate
...
(
    ...
    //AXIS master interface
    .axis_master_tvalid         (pcie_axis_master_tvalid),      //output
    .axis_master_tready         (pcie_axis_master_tready),      //input
    .axis_master_tdata          (pcie_axis_master_tdata ),      //output [127:0]
    .axis_master_tkeep          (pcie_axis_master_tkeep ),      //output [3:0]
    .axis_master_tlast          (pcie_axis_master_tlast ),      //output
    .axis_master_tuser          (pcie_axis_master_tuser ),      //output [7:0]
